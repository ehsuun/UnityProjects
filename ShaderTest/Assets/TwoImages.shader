Shader "Cg shader with two texture" {
	Properties{
		_ForwardTex("_ForwardTex Image", 2D) = "white" {}
		_BackTex("_BackTex Image", 2D) = "white" {}
		_UpTex("_UpTex Image", 2D) = "white" {}
		_DownTex("_DownTex Image", 2D) = "white" {}
		_LeftTex("_LeftTex Image", 2D) = "white" {}
		_RighttTex("_RightTex Image", 2D) = "white" {}
...
#pragma fragment frag 
	...
	float4 frag(vertexOutput input) : COLOR
	{
		...
		return tex2D(_ForwardTex, input.tex.xy);
	//return (tex2D(_ForwardTex, input.tex.xy)+ tex2D(_ForwardTex, input.tex.xy))/2.0;
